...
export function DetailAnimalPage(
  props: DetailAnimalPageProps
): React.JSX.Element {
  const { idPage } = props;
      ...
      <DetailPage>
        ...
        {animal ? (
          <>
            ...
            <TitleDetailPage>
              {t('animals.detail.general.title')}
            </TitleDetailPage>
            <InfosDetailPage>
              <RowInfosDetailPage>
                <LabelRowInfosDetailPage>
                  {t('animals.detail.general.id')}
                </LabelRowInfosDetailPage>
                <ValueRowInfosDetailPage>{animal.id}</ValueRowInfosDetailPage>
              </RowInfosDetailPage>
              <RowInfosDetailPage>
                <LabelRowInfosDetailPage>
                  {t('animals.detail.general.createAt')}
                </LabelRowInfosDetailPage>
                <ValueRowInfosDetailPage>
              ...
              <RowInfosDetailPage>
                <LabelRowInfosDetailPage>
                  {t('animals.detail.general.updateAt')}
                </LabelRowInfosDetailPage>
                <ValueRowInfosDetailPage>
              ...
              <RowInfosDetailPage
                onClick={() =>
                  animal.house &&
                  router.push(ROUTES.houses.detail(animal.house.id))
                }
              >
                <LabelRowInfosDetailPage>
                  {t('animals.detail.general.house')}
                </LabelRowInfosDetailPage>
                <ValueRowInfosDetailPage
